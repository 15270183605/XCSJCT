...
public class CustomStatusView extends View {
    ...
    public CustomStatusView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        progressColor = array.getColor(R.styleable.CustomStatusView_progress_color, R.color.colorPrimary);
        loadSuccessColor = array.getColor(R.styleable.CustomStatusView_load_success_color, R.color.load_success);
        loadFailureColor = array.getColor(R.styleable.CustomStatusView_load_failure_color, R.color.load_failure);
