...
import com.example.jiacaitong.R;
	...
	public class HorizontalMenu extends RelativeLayout {
	    ...
	    private void init(){
	        TypedArray typedArray = mContext.obtainStyledAttributes(mAttrs, R.styleable.HorizontalMenu);
	        defaultWidth = Utils.dip2px(mContext,200);
	        defaultHeight = Utils.dip2px(mContext,40);

	        menuBackColor = typedArray.getColor(R.styleable.HorizontalMenu_back_color,Color.WHITE);
	        menuStrokeSize = typedArray.getDimension(R.styleable.HorizontalMenu_stroke_size,1);
	        menuStrokeColor = typedArray.getColor(R.styleable.HorizontalMenu_stroke_color,Color.parseColor("#8cfffb"));
	        menuCornerRadius = typedArray.getDimension(R.styleable.HorizontalMenu_corner_radius,Utils.dip2px(mContext,20));

	        buttonStyle = typedArray.getInteger(R.styleable.HorizontalMenu_button_style,Right);
	        buttonIconDegrees = 90;
	        buttonIconSize = typedArray.getDimension(R.styleable.HorizontalMenu_button_icon_size,Utils.dip2px(mContext,8));
	        buttonIconStrokeWidth = typedArray.getDimension(R.styleable.HorizontalMenu_button_icon_stroke_width,8);
	        buttonIconColor = typedArray.getColor(R.styleable.HorizontalMenu_button_icon_color,Color.parseColor("#8cfffb"));

	        expandAnimTime = typedArray.getInteger(R.styleable.HorizontalMenu_expand_time,400);
	        typedArray.recycle();
